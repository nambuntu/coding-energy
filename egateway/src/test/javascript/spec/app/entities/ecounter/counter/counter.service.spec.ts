    ...
    describe('Counter Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'ecounter/api/counters';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Counter', () => {
                service.create(new Counter(null)).subscribe(received => {
            ...
            it('should update a Counter', () => {
                service.update(new Counter(123)).subscribe(received => {
            ...
            it('should return a list of Counter', () => {
                service.query(null).subscribe(received => {
                    expect(received.body[0].id).toEqual(123);
                });

                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new Counter(123)]);
            });
